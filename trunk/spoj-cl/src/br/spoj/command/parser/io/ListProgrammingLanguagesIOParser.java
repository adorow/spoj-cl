...
public class ListProgrammingLanguagesIOParser implements SpojCommandIOParser<ListProgrammingLanguages> {

	/**
	 * {@inheritDoc}
	 */
	public ListProgrammingLanguages parse(Console in) throws InvalidArgumentsException {
