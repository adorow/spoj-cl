 ...
 */
public interface SpojCommandIOParser<T extends SpojCommand> {

	/**
	 * Parse the arguments and create a {@link SpojCommand} with them.
	 * @param in para ler dados informados pelo usuário.
	 * 
	 ...
	 */
	T parse(Console in) throws InvalidArgumentsException;
