...
public class LoginIOParser implements SpojCommandIOParser<Login> {

	/**
	 * {@inheritDoc}
	 */
	public Login parse(Console in) throws InvalidArgumentsException {
		String user = in.readLine("> Username: ");
		String password = new String(in.readPassword("> Password: "));
