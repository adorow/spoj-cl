...
public class StatusIOParser implements SpojCommandIOParser<Status> {

	/**
	 * {@inheritDoc}
	 */
	public Status parse(Console in) throws InvalidArgumentsException {
		String id = in.readLine("> Submission id: ");
