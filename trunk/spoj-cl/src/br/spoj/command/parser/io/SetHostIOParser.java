...
public class SetHostIOParser implements SpojCommandIOParser<SetHost> {

	/**
	 * {@inheritDoc}
	 */
	public SetHost parse(Console in) throws InvalidArgumentsException {
		String hostAbbreviation = in.readLine("> Host abbreviation: ");
