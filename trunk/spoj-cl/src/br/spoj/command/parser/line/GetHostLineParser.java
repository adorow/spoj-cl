...
import br.spoj.command.GetHost;
import br.spoj.command.parser.InvalidArgumentsException;

public class GetHostLineParser implements SpojCommandLineParser<GetHost> {

	/**
	 * {@inheritDoc}
	 */
	public GetHost parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 0) {
			throw new InvalidArgumentsException("The gethost command has no parameters");
		}
