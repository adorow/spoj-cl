...
import br.spoj.command.Problem;
import br.spoj.command.parser.InvalidArgumentsException;

public class ProblemLineParser implements SpojCommandLineParser<Problem> {

	/**
	 * {@inheritDoc}
	 */
	public Problem parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 1) {
			throw new InvalidArgumentsException("The problem command needs one parameter: problemCode");
		}
		
		String problemCode = arguments[0];
