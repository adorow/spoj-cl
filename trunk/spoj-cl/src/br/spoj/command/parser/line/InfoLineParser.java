...
public class InfoLineParser implements SpojCommandLineParser<Info> {

	/**
	 * {@inheritDoc}
	 */
	public Info parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 0) {
			throw new InvalidArgumentsException("The info command has no parameters");
		}
