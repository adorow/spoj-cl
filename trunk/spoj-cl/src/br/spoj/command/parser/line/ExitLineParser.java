...
import br.spoj.command.Exit;
import br.spoj.command.parser.InvalidArgumentsException;

public class ExitLineParser implements SpojCommandLineParser<Exit> {

	/**
	 * {@inheritDoc}
	 */
	public Exit parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 0) {
			throw new InvalidArgumentsException("The exit command has no parameters");
		}
