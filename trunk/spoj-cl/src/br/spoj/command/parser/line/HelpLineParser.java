...
import br.spoj.command.Help;
import br.spoj.command.parser.InvalidArgumentsException;

public class HelpLineParser implements SpojCommandLineParser<Help> {

	/**
	 * {@inheritDoc}
	 */
	public Help parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 0) {
			throw new InvalidArgumentsException("The help command has no parameters");
		}
