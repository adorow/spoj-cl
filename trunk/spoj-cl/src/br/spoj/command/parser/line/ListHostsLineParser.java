...
import br.spoj.command.ListHosts;
import br.spoj.command.parser.InvalidArgumentsException;

public class ListHostsLineParser implements SpojCommandLineParser<ListHosts> {

	/**
	 * {@inheritDoc}
	 */
	public ListHosts parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 0) {
			throw new InvalidArgumentsException("The listhosts command has no parameters");
		}
