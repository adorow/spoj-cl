...
public class ProblemIOParser implements SpojCommandIOParser<Problem> {

	/**
	 * {@inheritDoc}
	 */
	public Problem parse(Console in) throws InvalidArgumentsException {
		String code = in.readLine("> Problem code: ");
