...
import br.spoj.command.License;
import br.spoj.command.parser.InvalidArgumentsException;

public class LicenseLineParser implements SpojCommandLineParser<License> {

	/**
	 * {@inheritDoc}
	 */
	public License parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 0) {
			throw new InvalidArgumentsException("The license command has no parameters");
		}
