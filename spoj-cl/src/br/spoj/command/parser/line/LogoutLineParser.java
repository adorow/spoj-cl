...
import br.spoj.command.Logout;
import br.spoj.command.parser.InvalidArgumentsException;

public class LogoutLineParser implements SpojCommandLineParser<Logout> {
	
	/**
	 * {@inheritDoc}
	 */
	public Logout parse(String... arguments) throws InvalidArgumentsException {
		if (arguments.length != 0) {
			throw new InvalidArgumentsException("The logout command has no parameters");
		}
		return new Logout();
	}
